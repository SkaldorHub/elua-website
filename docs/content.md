...
| Wo | Aktueller Platzhalter | Ersetzen durch |
|---|---|---|
| Startseite, Abschnitt Kontakt | `kontakt@example.org` (Mail-Link) | echte Kontaktadresse |
| Seite Impressum | Name, Anschrift, Vertretung, Telefon, Mail, Vereinsregister, Verantwortliche Person, Bildnachweis (alles Beispielwerte) | echte Angaben |
| Seite Impressum, gelber Hinweiskasten | Hinweis "Vorlage mit Platzhalterdaten" | löschen, sobald die Angaben stimmen |

Beides wird im Cloud-Editor gepflegt. Danach Deploy auslösen (siehe [workflow.md](workflow.md)).
...
- Ausgenommen sind rein private Seiten ohne wirtschaftlichen Bezug (etwa Familienfotos). Die Chor-Seite ist öffentlich, wirbt um neue Sänger und bietet "Buchen Sie uns" an. Das ist ein Außenauftritt mit wirtschaftlichem Bezug. Ein Impressum ist deshalb praktisch Pflicht.
...
- Echte Kontakt- und Impressumsdaten, Datenschutzerklärung.
